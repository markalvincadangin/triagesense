  ...
  return (
    <>
      ...
      >
        ...
        {isOpen && (
          <div
            className={`absolute w-[390px] max-w-[92vw] max-h-[85vh] bg-slate-900 text-slate-100 rounded-2xl shadow-2xl border border-slate-700/80 backdrop-blur-2xl animate-fade-in flex flex-col overflow-hidden ${
              isNearRight ? 'right-0' : 'left-0'
            } ${isNearBottom ? 'bottom-14' : 'top-14'}`}
          >
            {/* ── Pinned Top Bar ─────────────────────────────────────────────── */}
            <div className="flex items-center justify-between p-3.5 pb-2.5 border-b border-slate-800 bg-slate-900/95 shrink-0">
              <div className="flex items-center gap-2">
            ...
            {/* ── Pinned Category Navigation Tabs ─────────────────────── */}
            <div className="px-3.5 pt-2.5 pb-2 bg-slate-900/95 border-b border-slate-800/80 shrink-0">
            ...
            {/* ── Scrollable Body for Active Tab Content ─────────────────── */}
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between">
                            ...
                            <span className={`text-[9px] font-mono px-2 py-0.5 rounded font-bold uppercase ${
                              emergencyAlert.active
                                ? 'bg-red-600 text-white animate-pulse'
                                : 'bg-slate-950 text-red-300 border border-red-900/60'
                            }`}>
                              {emergencyAlert.active ? 'ACTIVE' : 'Emergency'}
                            </span>
                          </div>
                          <p className="text-[10px] text-slate-300 mt-0.5 leading-snug">
                            {emergencyAlert.active
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-[9px] font-mono px-2 py-0.5 rounded bg-slate-950 text-blue-300 border border-blue-900/60 font-semibold">
                              Live Queue
                            </span>
                          </div>
                          <p className="text-[10px] text-slate-300 mt-0.5 leading-snug">
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-[9px] font-mono px-2 py-0.5 rounded bg-slate-950 text-emerald-300 border border-emerald-900/60 font-semibold">
                              Totem Fleet
                            </span>
                          </div>
                          <p className="text-[10px] text-slate-300 mt-0.5 leading-snug">
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      <div className="grid grid-cols-2 gap-1.5">
                        <button
                          ...
                          className="flex items-center gap-2 p-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-left border border-slate-700/60 transition-colors cursor-pointer"
                          title="Simulate presenting QR code to optical scanner bay"
                        >
                          <div className="w-7 h-7 rounded-lg bg-blue-950/80 border border-blue-700/60 flex items-center justify-center text-blue-400 shrink-0">
                            <QrCode size={14} />
                          </div>
                          <div className="flex flex-col min-w-0">
                            <span className="text-xs font-semibold text-white leading-tight">Scan QR</span>
                            <span className="text-[10px] text-slate-400">PhilHealth</span>
                          </div>
                        </button>
                        ...
                        >
                          <div className="w-7 h-7 rounded-lg bg-emerald-950/80 border border-emerald-700/60 flex items-center justify-center text-emerald-400 shrink-0">
                            <Wifi size={14} className="rotate-90" />
                          </div>
                          <div className="flex flex-col min-w-0">
                            <span className="text-xs font-semibold text-white leading-tight">Tap NFC</span>
                            <span className="text-[10px] text-slate-400">PhilSys ID</span>
                          </div>
                        </button>
                      </div>
                      ...
                      <button
                        ...
                        className="flex items-center justify-between px-3 py-2 rounded-xl bg-red-950/40 hover:bg-red-950/60 text-xs font-medium text-red-200 border border-red-900/80 transition-colors cursor-pointer"
                        title="Simulate unreadable barcode (Demonstrates Error Recovery flow)"
                      >
                        <span className="flex items-center gap-2">
                          <AlertCircle size={13} className="text-red-400 shrink-0" />
                          <span>Simulate Code Read Failure</span>
                        </span>
                        <span className="text-[9px] uppercase px-1.5 py-0.5 rounded bg-red-900/80 text-red-200 font-mono font-semibold">Error Demo</span>
                      </button>
                    </div>
                    ...
                    <div className="flex flex-col gap-1.5 pt-1 border-t border-slate-800">
                      ...
                      <div className="grid grid-cols-2 gap-1.5">
                        ...
                        >
                          ...
                          <div className="flex flex-col min-w-0">
                            <span className="text-xs font-semibold text-white leading-tight">Normal Vitals</span>
                            <span className="text-[10px] text-emerald-400 font-mono font-medium">98% • 74 bpm</span>
                          </div>
                        </button>
                        ...
                        >
                          <div className="w-7 h-7 rounded-lg bg-red-950/80 border border-red-700/60 flex items-center justify-center text-red-400 shrink-0">
                            <Activity size={14} />
                          </div>
                          <div className="flex flex-col min-w-0">
                            <span className="text-xs font-semibold text-white leading-tight">Critical Vitals</span>
                            <span className="text-[10px] text-red-400 font-mono font-medium">91% • 122 bpm</span>
                          </div>
                        </button>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-1.5">
                        ...
                        >
                          ...
                          <div className="flex flex-col min-w-0">
                            <span className="text-xs font-semibold text-white leading-tight">Normal Core</span>
                            <span className="text-[10px] text-cyan-400 font-mono font-medium">36.6°C</span>
                          </div>
                        </button>
                        ...
                        >
                          <div className="w-7 h-7 rounded-lg bg-amber-950/80 border border-amber-700/60 flex items-center justify-center text-amber-400 shrink-0">
                            <Thermometer size={14} />
                          </div>
                          <div className="flex flex-col min-w-0">
                            <span className="text-xs font-semibold text-white leading-tight">High Fever</span>
                            <span className="text-[10px] text-amber-400 font-mono font-medium">38.9°C</span>
                          </div>
                        </button>
                      </div>
                      ...
                      <button
                        ...
                        className="flex items-center justify-between px-3 py-2 rounded-xl bg-amber-950/40 hover:bg-amber-950/60 text-xs font-medium text-amber-200 border border-amber-900/80 transition-colors cursor-pointer"
                        title="Simulate finger motion artifact error (Demonstrates Error Recovery flow)"
                      >
                        <span className="flex items-center gap-2">
                          <AlertCircle size={13} className="text-amber-400 shrink-0" />
                          <span>Simulate Motion Artifact</span>
                        </span>
                        <span className="text-[9px] uppercase px-1.5 py-0.5 rounded bg-amber-900/80 text-amber-200 font-mono font-semibold">Fault Demo</span>
                      </button>
                    </div>
                  </div>
                </div>
            ...
            {/* ── Pinned Footer ──────────────────────────────────────────────── */}
            <div className="p-2.5 px-3.5 border-t border-slate-800 bg-slate-900/95 shrink-0 flex items-center justify-between text-[11px] text-slate-400">
